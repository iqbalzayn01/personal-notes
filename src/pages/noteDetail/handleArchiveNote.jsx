...
export default function HandleArchiveNote({ handleArchiveNote, isLoading }) {
  return (
    <CButton
      ...
      className="hover:bg-yellow-400 text-4xl bg-csecondary dark:bg-white rounded-full p-3 cursor-pointer"
      loading={isLoading}
      disabled={isLoading}
    >
      <svg
