...
export default function HandleDeleteNote({ handleDeleteNote, isLoading }) {
  return (
    <CButton
      ...
      className="hover:bg-red-400 text-4xl bg-csecondary dark:bg-white rounded-full p-3 cursor-pointer"
      loading={isLoading}
      disabled={isLoading}
    >
      <svg
